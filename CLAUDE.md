...
| 2.5 | Talon LTM + sqlite-vec | ✅ Complete (2026-05-31) | Auto fact recall across sessions — live smoke verified via gh/github-copilot (stored "dark mode" in session 1, recalled in session 2) |
